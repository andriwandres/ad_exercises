...
public final class BinaryInsertionSortBenchmarkManual {
    private static final int ITERATIONS = 10;
    private static final int WARMUP_ITERATIONS = 10;

    public static void main(String[] args) throws Exception {
        Callable<Long> task = BinaryInsertionSortBenchmarkManual::with400kRandomElements;
    ...
    private static long with100kRandomElements() {
        ...
        return BenchmarkUtilities.benchmark(() -> SortUtility.binaryInsertionSort(array));
    }
